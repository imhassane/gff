...
export const RegisterFormFirstStep = (props) => {
    const { onUsernameChange, onEmailChange, errors, onNextStep } = props;
...
export const RegisterFormSecondStep = (props) => {
    const { onPasswordChange, onRepeatPasswordChange, errors, onNextStep } = props;
    ...
    return (
        <form className="uk-form-stacked uk-position-center">
            ...
            <input className="uk-button uk-button-danger" disabled={ (errors.password !== null || errors.repeatPassword !== null )} type="button" value="Etape suivante - choix d'une photo de profil" onClick={ _ => onNextStep() } />
        </form>
    );
};

export const RegisterFormThirdStep = (props) => {
    const { onPictureChange, errors, onFormSubmit, onUploadAndSubmit } = props;
    ...
    return (
        <form className="uk-form-stacked uk-position-center">
            ...
            <div className="uk-margin">
                <input className="uk-button uk-button-secondary" type="button" value="Sauter cette étape" onClick={ _ => onFormSubmit() }/>
